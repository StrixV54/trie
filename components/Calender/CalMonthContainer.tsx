import { genAWeekOfDate, genCalendarArr } from '@/utils/date'
import CalMonthCell from './CalMonthCell'
import { DragDropContext } from 'react-beautiful-dnd'
import useCalendarAction from './useCalendarAction'
import { ICalendarView } from '@/context/CalenderContext'
...
export default function CalMonthContainer({ date, type }: ICalMonthContainerProps) {
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <CalendarHeader />
      <div className={`calendar-wrapper ${isWeekView ? 'week-view' : ''}`}>
